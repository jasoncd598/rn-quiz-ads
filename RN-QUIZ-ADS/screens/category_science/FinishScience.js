    ...
    <View style={style.container}>
      <View style={style.innerContainer}>
        <View style={{ justifyContent:'center', alignItems:'center'}}>
          ...
          <Text style={{ fontSize:18, marginTop:25, textAlign:'center', color:'#2E2E2E'}}>Congratulations! You've Completed the Science Twist Mania</Text>
        </View>
        <View style={{ marginTop:25 }}>
          <TouchableOpacity style={style.buttonStyle} onPress={() => { navigation.replace('Science_Level1Screen')}}>
