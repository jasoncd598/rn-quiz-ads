...
const Science_Level13 = ({ navigation }) => {
    ...
    useEffect(() => {
       async function init(){
            try {
                await AsyncStorage.setItem('@userLevelScience', '13')
            } catch (e) {
                console.log(`Error ${e}`)
            }
    ...
    <View style={styles.container}>
...

        {
            ...
            <View style={styles.modalChecker}>
                <TouchableOpacity style={styles.modalChecker} onPress={() => { navigation.push('Science_Level14Screen') }}>
                    <View>
                    ...
                    <View style={{ margin: 25, justifyContent:'center', alignItems:'center' }}>
                        <Text style={{ color:'#747474', textAlign:'center'}}>A cell is the smallest unit of life that can perform all the functions necessary for life, such as metabolism and reproduction. Atoms and molecules make up cells, but they cannot perform the functions of life on their own. Organs are made up of multiple cells and perform specific functions within an organism</Text>
                    </View>
...
export default Science_Level13
