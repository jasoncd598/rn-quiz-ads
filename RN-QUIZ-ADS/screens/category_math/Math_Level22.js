...
const Math_Level22 = ({ navigation }) => {
    ...
    useEffect(() => {
       async function init(){
            try {
                await AsyncStorage.setItem('@userLevelMath', '22')
            } catch (e) {
                console.log(`Error ${e}`)
            }
    ...
    <View style={styles.container}>
...

        {
            ...
            <View style={styles.modalChecker}>
                <TouchableOpacity style={styles.modalChecker} onPress={() => { navigation.push('Math_Level23Screen') }}>
                    <View>
                    ...
                    <View style={{ margin: 25, justifyContent:'center', alignItems:'center' }}>
                        <Text style={{ color:'#747474', textAlign:'center'}}>To evaluate this expression we have to follow the order of operations (PEMDAS), Parentheses, Exponents, Multiplication and Division, and Addition and Subtraction. The first step is to do the multiplication, which gives us 4x5 = 20. Next, we do the addition and subtraction in order from left to right, getting 3 + 20 - 2 = 21</Text>
                    </View>
